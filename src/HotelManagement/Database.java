    ...
    public void assignRoom(User u) {
        ...
        if(u.getTier() == 2){
            ...
            if(tier1Rooms.isEmpty()){
                ...
                if(tier1Rooms.size() <= 100 && tier1Rooms.get(tier1Rooms.size()-1) != 299) {
                    int count = 0;
                    while (tier1Rooms.size() > count) {
                        count++;
                    }
                    u.setRoomNum(count + 200);
                    tier1Rooms.add(count + 200);
                }
        ...
        if(u.getTier() == 3){
            ...
            if(tier1Rooms.isEmpty()){
                ...
                if(tier1Rooms.size() <= 100 && tier1Rooms.get(tier1Rooms.size()-1) != 399) {
                    int count = 0;
                    while (tier1Rooms.size() > count) {
                        count++;
                    }
                    u.setRoomNum(count + 300);
                    tier1Rooms.add(count + 300);
                }
        ...
        if(u.getTier() == 4){
            ...
            if(tier1Rooms.isEmpty()){
                ...
                if(tier1Rooms.size() <= 100 && tier1Rooms.get(tier1Rooms.size()-1) != 499) {
                    int count = 0;
                    while (tier1Rooms.size() > count) {
                        count++;
                    }
                    u.setRoomNum(count + 400);
                    tier1Rooms.add(count + 400);
                }
        ...
        if(u.getTier() == 5){
            ...
            if(tier1Rooms.isEmpty()){
                ...
                if(tier1Rooms.size() <= 100 && tier1Rooms.get(tier1Rooms.size()-1) != 509) {
                    int count = 0;
                    while (tier1Rooms.size() > count) {
                        count++;
                    }
                    u.setRoomNum(count + 500);
                    tier1Rooms.add(count + 500);
                }
